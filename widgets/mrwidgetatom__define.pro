...
;   methods.
;
;   Unless the /FUNCTION_CALLBACKS keyword is set, any keyword that turns events ON or OFF
...
;---------------------------------------------------------------------
    ...
    if n_elements(function_callbacks) gt 0 then begin
...
;                                   For function event handling, set the
;                                   `FUNCTION_CALLBACKS` keyword. If set, all of the
;                                   *_HANDLER keywords will be ignored.
